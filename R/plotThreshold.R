...
data(probe.features)
    ...
    axis(side=3, at=c(1:no.feat.rel), labels=paste("N =", format(as.numeric(tapply(myResults$nrst.probe, myResults$feat.rel, length)), big.mark=",", scientific=F), sep=""), tick=FALSE, cex.axis=0.8, las=2)
